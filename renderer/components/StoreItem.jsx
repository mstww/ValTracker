  ...
  return(
    <>
      ...
      <motion.div 
        ...
        id={'item-box'}
        className={'group z-10 h-full relative border border-tile-color bg-tile-color bg-opacity-30 rounded shadow-lg hover:shadow-2xl hover:bg-opacity-60 hover:z-0 transition-all duration-100 ease-in ' + (item ? '' : 'pointer-events-none ') + (nightMarket ? 'w-5/6 mx-auto mb-4' : 'w-1/4 mr-2')}
        onClick={(e) => {
