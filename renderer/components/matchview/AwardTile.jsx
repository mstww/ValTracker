  ...
  return(
    <div className={'w-full border-2 rounded border-maincolor-lightest mb-2 overflow-hidden p-1 award-tile'}>
      <span className='ml-1.5 relative top-0 flex flex-row'>
        { icon === '/images/chess.svg' ? <Chess className='w-9 h-10 transform scale-75 relative bottom-2 right-2 shadow-img' /> : null }
        ...
        { icon === '/images/crosshair.svg' ? <Crosshair className='w-6 relative bottom-px shadow-img transform rotate-45' /> : null }
