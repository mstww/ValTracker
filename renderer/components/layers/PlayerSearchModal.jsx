        ...
        <div className={(searchHistory.length > 0 ? 'block' : 'hidden' )}>
          ...
          <ul className='w-full mt-1'>
            {searchHistory.map((searchValue, index) => {
              return(
                <li 
                  className='w-full flex items-center p-2 border border-tile-color bg-tile-color bg-opacity-60 rounded hover:bg-opacity-100 transition-all duration-100 ease-linear'
                  onClick={(e) => {
