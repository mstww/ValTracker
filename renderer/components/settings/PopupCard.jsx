...
export default function PopupCard({ useRef, header, text, button_1, button_2, button_1_onClick, button_2_onClick, isOpen, isButtonClickable, children }) {
  return(
    <motion.div 
      id='settings-overlay-card' 
      ref={useRef} 
      className='w-96 rounded-sm bg-maincolor mb-8 flex flex-col justify-between p-4 pb-2 pointer-events-auto shadow-lg relative'
